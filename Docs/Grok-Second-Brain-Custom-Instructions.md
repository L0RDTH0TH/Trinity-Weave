...
| ------- | ------------- | ------------------- |
| **Mint pack (walk queue)** | `main` → `Docs/catalog-mint/<project_id>/` | Backlog, FEED-ENVELOPE, BATCH-DIGEST, PACK-MANIFEST, shared rubric — **what to walk next** |
...
3. Open `main` pack: `Docs/catalog-mint/<project_id>/` — `MINT-PACK.md` (**Walk Order**), `PACK-MANIFEST.yaml`, `MINT-BACKLOG.yaml` (or `.md`), `FEED-ENVELOPE.yaml`, `CHILD-BATCH-STATUS.md`.
...
6. Shared law on `main`: `Docs/catalog-mint/_shared/UX-MINT-RUBRIC.md`, `FRICTION-CHECK.md`, `SERIES-ALTITUDE-EXEMPLARS.md`, **`CHILD-BATCH-VALIDATION.md`** (Pass B receipt shape).
