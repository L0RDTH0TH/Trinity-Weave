...
See also [[PILLARS-AND-LENS]] · [[CLASS-EXPRESSION-BOARD]] · [[COMBAT-SURFACE-TEXTURE]] · [[ROLEPLAY-SURFACE-TEXTURE]] · [[QUIET-BETWEEN-TEXTURE]] · [[SKILL-READABILITY-TEXTURE]] · [[ITEM-COMMISSION-TEXTURE]] · [[VOICE-TABLE-TEXTURE]].
...
9. **Quiet-between texture (2026-08-11):** travel/camp loop as ordinary exploration surface — continuous fiction, soft world pressure, in-adventure boundaries. Cards: `quiet-travel-camp-loop`, `quiet-soft-world-pressure`, `quiet-surface-boundaries`. Combat exit residue already locked (hands in). Carry-forward: 180° humanoid default still open. Disposition **open**.
...
**BBEGs feedstock lock (2026-08-13 — this surface only):**

| Lock | Statement |
|------|-----------|
| **Apex pressure node** | Person, institution/faction finger, or ecological force — not a scripted end-boss waiting for a final fight. |
| **Concurrency** | Power-banded: C=1, B=2, A=up to 3. |
| **Off-screen** | Continues to act while the party is elsewhere; lieutenant/resource hits produce visible responses. |
| **Info control** | Reuses existing DM rumor / knowledge-flow / reveal surfaces — no extra BBEG-reveal system. |
...
**Multiclass / feats / post-20 feedstock lock (2026-08-13 — this surface only):**

| Lock | Statement |
|------|-----------|
| **Same character** | Expansion stays readable as the same character’s expression surface — no second class desk. |
| **Hard constraints** | Thin-base, subclass-primary, and fixed primary direction remain. Core class + subclass stay dominant. |
| **DM gate** | Multiclass and post-20 are DM-gated; system is not the hard limiter. Soft thematic/readability guidance sits alongside. |
