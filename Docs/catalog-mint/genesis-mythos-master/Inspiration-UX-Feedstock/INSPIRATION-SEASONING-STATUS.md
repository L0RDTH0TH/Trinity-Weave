...
| `class-unique-expression-surfaces` *(draft board v3)* | PC creation, combat, mental-stat, table, quiet, authorship | medium | CLASS-EXPRESSION-BOARD.md v3 — capacity + inventory + murderhobo; validate before seasoning |

## Class-expression board (draft v3 — 2026-08-11)

Board path: `Inspiration-UX-Feedstock/CLASS-EXPRESSION-BOARD.md`  
Upgrade: thin base / subclass-primary capacity; inventory shared surface; murderhobo; fixed primary direction; full-grain Totem, Berserker, Beast Master, Circle, Artificer chain.  
...
- [x] Class-expression board draft v3 (capacity + inventory + murderhobo)
- [ ] Grok+User validation of CLASS-EXPRESSION-BOARD v3
