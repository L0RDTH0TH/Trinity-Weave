...
**Pin gate open.** Progressive distillation. Class-expression **board draft v2** ready for Grok+User validation.
...
| `class-unique-expression-surfaces` *(draft board v2)* | PC creation, combat, mental-stat, table, quiet, authorship | medium | CLASS-EXPRESSION-BOARD.md v2 — method locks + Sorcerer atelier; validate before seasoning weight |

## Class-expression board (draft v2 — 2026-08-11)

Board path: `Inspiration-UX-Feedstock/CLASS-EXPRESSION-BOARD.md`  
Upgrade: pattern-learning north star; universal skip; revised contrasts; Sorcerer weave-atelier.  
Status: **draft_for_grok_user_validation** — not maps-applied.
...
- **Focused distillation next:** class-unique expression player-facing texture
...
- [x] Class-expression board draft v2 (method locks + Sorcerer atelier)
- [ ] Grok+User validation of CLASS-EXPRESSION-BOARD v2
