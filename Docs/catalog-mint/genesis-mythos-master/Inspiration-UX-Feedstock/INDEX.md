...
| Operator class-expression doctrine | medium | class-unique-expression-surfaces | **CLASS-EXPRESSION-BOARD draft v3** — capacity + inventory + murderhobo; validate with Grok+User |
