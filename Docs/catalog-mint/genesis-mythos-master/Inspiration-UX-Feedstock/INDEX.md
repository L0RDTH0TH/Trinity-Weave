...
| Operator class-expression doctrine | medium | class-unique-expression-surfaces | **CLASS-EXPRESSION-BOARD draft v2** — method locks + Sorcerer atelier; validate with Grok+User |
...
| Red Dead Redemption | medium | stub-rdr-mount-feel | Mount / landscape |
| Fable | strong | relationship-shaped-economy | Relationship → prices / marriage vs thin romance gates |
...
| Surface | Signal | Derived pins | Notes |
|---------|--------|--------------|-------|
| Community mods (esp. Skyrim exploration/survival stacks) | strong | mod-community-weak-spot-augments | Weak parts of base + how players augmented (Campfire+Frostfall-class); placement UX may rhyme with DM Forge |
