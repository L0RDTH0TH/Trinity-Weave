---
title: Walk — ux_wa_faction_reputation
row_id: ux_wa_faction_reputation
parent_id: ux_living_world_continuity
walk_tier: coverage
label: Reputation standing surface
status: done
---
...
- depth_band: 1
- does_not_mandate: []
- alternatives_not_banned: ["Slow reputation drift vs sharp standing breaks on return", "Faction-facing rep only vs personal PC standing residue"]
