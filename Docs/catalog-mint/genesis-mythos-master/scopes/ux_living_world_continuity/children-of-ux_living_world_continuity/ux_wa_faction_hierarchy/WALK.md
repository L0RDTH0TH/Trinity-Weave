---
title: Walk — ux_wa_faction_hierarchy
row_id: ux_wa_faction_hierarchy
parent_id: ux_living_world_continuity
walk_tier: coverage
label: Faction hierarchy surface
status: pending
---
...
- depth_band: 1
- does_not_mandate: []
- alternatives_not_banned: ["Flat faction presence vs visible rank/chain-of-command shifts", "Quiet leadership change vs table-readable succession residue"]
