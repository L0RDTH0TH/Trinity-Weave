---
title: Walk — ux_wa_npc_sheet
row_id: ux_wa_npc_sheet
parent_id: ux_living_world_continuity
walk_tier: coverage
label: NPC identity sheet feel
status: pending
---
...
- depth_band: 1
- does_not_mandate: []
- alternatives_not_banned: ["Thin continuity sheet vs richer off-screen status block", "Combat/stat sheet bias vs social/continuity fields on return"]
