---
title: Walk — ux_baseline_fp
row_id: ux_baseline_fp
parent_id: ux_camera_control_envelopes
walk_tier: coverage
label: Baseline first-person embodiment
status: done
---
...
- depth_band: 1
- does_not_mandate: []
- alternatives_not_banned: ["Minimal HUD vs richer diegetic embodiment chrome", "Strict FP-only default vs rare comfort assists that still restore to FP"]
