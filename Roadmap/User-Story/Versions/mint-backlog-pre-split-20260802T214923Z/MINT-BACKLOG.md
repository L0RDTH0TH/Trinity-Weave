...
> **2026-08-01 record (addition, not remine):** PMG three-layer delivery (System + Reference Exemplar + Operator modularity). Exemplar graphics ≠ new series parents. Continue children validate. See [[MINT-QUALITY-CAVEAT]], [[REFERENCE-EXEMPLAR-CHARTER]], CDR [[Conceptual-Decision-Records/reference-exemplar-dual-goal-2026-08-01]]. Trinity sync later.
...
#### Series parent `ux_backstory_legacy_integration`
...
**Children of `ux_backstory_legacy_integration`**
...
#### Series parent `ux_camera_control_envelopes`
...
**Children of `ux_camera_control_envelopes`**
...
#### Series parent `ux_collaborative_table_agency`
...
**Children of `ux_collaborative_table_agency`**
...
#### Series parent `ux_combat_play_surface`
...
**Children of `ux_combat_play_surface`**
...
#### Series parent `ux_living_world_continuity`
...
**Children of `ux_living_world_continuity`**
...
#### Series parent `ux_quiet_between_pillars`
...
#### Series parent `ux_world_authorship_modability`
...
**Children of `ux_world_authorship_modability`**
...
#### Series parent `ux_dm_campaign_creation`
...
**Children of `ux_dm_campaign_creation`**
...
#### Series parent `ux_dm_session_prep`
...
**Children of `ux_dm_session_prep`**
...
#### Series parent `ux_mental_stat_interpretation`
...
#### Series parent `ux_player_character_creation`
...
#### Series parent `ux_world_generation`
...
**Children of `ux_world_generation`**
