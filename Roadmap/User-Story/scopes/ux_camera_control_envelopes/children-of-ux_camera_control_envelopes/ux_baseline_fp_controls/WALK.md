---
title: Walk — ux_baseline_fp_controls
row_id: ux_baseline_fp_controls
parent_id: ux_camera_control_envelopes
walk_tier: coverage
label: Baseline FP controls
status: done
---
...
- depth_band: 1
- does_not_mandate: []
- alternatives_not_banned: ["Gesture-light vs denser intent surfaces in FP", "Look-then-act vs simultaneous look/move issuance"]
