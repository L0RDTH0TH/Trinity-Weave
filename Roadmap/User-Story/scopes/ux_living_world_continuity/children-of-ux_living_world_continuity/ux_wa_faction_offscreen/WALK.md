---
title: Walk — ux_wa_faction_offscreen
row_id: ux_wa_faction_offscreen
parent_id: ux_living_world_continuity
walk_tier: coverage
label: Off-screen faction activity
status: done
---
...
- depth_band: 1
- does_not_mandate: []
- alternatives_not_banned: ["Sparse off-screen faction ticks vs denser between-session deltas", "DM-only offscreen log vs player rumor/residue of those ticks"]
