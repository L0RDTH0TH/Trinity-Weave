---
title: Walk — ux_wa_npc_secrets
row_id: ux_wa_npc_secrets
parent_id: ux_living_world_continuity
walk_tier: coverage
label: NPC secrets / knowledge gates
status: done
---
...
- depth_band: 1
- does_not_mandate: []
- alternatives_not_banned: ["Secrets stay sealed vs partial reveal after off-screen pressure", "DM-only secret log vs playable discovery hooks on return"]
