...
**80%** handoff_readiness — implementer can classify agency vs observe without guessing Sensorium+dominate. Slice feed **green** `1158≤1200`. Project harness **red** `project_RED:5.1.3:1353>1200` (4.3.2 cleared 1189≤1200; 5.1.1/5.1.2 ≤1200).
