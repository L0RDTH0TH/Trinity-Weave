...
def render_l5_affirm_digest(
    ...
    *,
    ...
    lines = [
        ...
        "## Contract (What it is)",
        "",
        _section_body(text, "What it is")[:800] or "_(missing)_",
        "",
        "## Moments",
        "",
        _section_body(text, "Moment inventory")[:1200] or "_(missing)_",
        "",
        "## PoC cut",
        "",
        _section_body(text, "Early / PoC cut")[:600] or "_(missing)_",
        "",
        "## Gate",
        "",
        f"- ok: {aff.ok}",
